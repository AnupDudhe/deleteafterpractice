        ...
        stage('test') {
         ...
         stage('deploy') {
            steps {
             sh  ''' 
                sudo rm -rf opt/*
                sudo rm -rf /home/ubuntu/workspace/webserver/apache-tomcat-9.0.113.zip  apache-tomcat-9.0.113
                sudo curl -O  https://dlcdn.apache.org/tomcat/tomcat-9/v9.0.113/bin/apache-tomcat-9.0.113.zip 
                sudo apt install unzip -y 
                sudo unzip apache-tomcat-9.0.113.zip
                sudo cp -r  apache-tomcat-9.0.113 /opt/ 
                sudo mv /home/ubuntu/workspace/webserver/target/studentapp-2.2-SNAPSHOT.war  /opt/apache-tomcat-9.0.113/webapps/student.war
                sudo aws s3 cp /opt/apache-tomcat-9.0.113/webapps/student.war s3://cbz-artifacts/
                sudo mv /home/ubuntu/workspace/webserver/mysql-connector.jar /opt/apache-tomcat-9.0.113/lib/
                sudo mv /home/ubuntu/workspace/webserver/context.xml /opt/apache-tomcat-9.0.113/conf/
                sudo chmod 777 /opt/apache-tomcat-9.0.113/bin/catalina.sh
                sudo bash /opt/apache-tomcat-9.0.113/bin/catalina.sh start
